...
# Detect CpG islands using window and CG count threshold (15%)
...
plt.title("Normalized Distribution of CpG Islands in Chromosomes Z, W, and 28 (15% Threshold)", fontsize=14)
